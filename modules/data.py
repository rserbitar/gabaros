...
skills = [
    ...
    ["Carouse", "Physical", 0.67],
    ["Perform", "Physical", 1.33],
    ["Dancing", "Perform", 1],
    ["Singing", "Perform", 1],
    ["Stealth", "Physical", 2],
    ["Hideing", "Stealth", 1],
    ...
    ["Magic", None, 4],
    ["Askenning", "Magic", 1],
    ["Spellcasting", "Magic", 2],
    ["Spellslinging", "Spellcasting", 1],
    ["Counterspelling", "Spellcasting", 1],
    ...
    ["First Aid", "Medics", 1],
    ["Social", "Technical", 1.33],
    ["Disguise", "Social", 1],
    ["Forgery", "Social", 1],
    ['Locomotion', None, 4.89],
    ['Vehicle Mechanics', 'Locomotion', 2.67],
...
ware = [
    ...
    ["Wired Reflexes I", "cyberware", 0, 0, 0, "Cybernetic nerve replacement", 1000, 5000,
     ["Vertebrae"], [['stats', 'Physical Reaction', '+10']], ''],
