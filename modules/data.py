...
gameitems = [
    ...
    ["Taser", "Ranged Weapon", 0, 200, 0.5, 30, 10, 10, False],
    ["Hold-Out Pistol", "Ranged Weapon", 5, 300, 0.4, 30, 5, 15, False],
    ["Light Pistol", "Ranged Weapon", 0, 300, 0.6, 26, 1, 20, False],
    ...
    ["Sport Rifle", "Ranged Weapon", 15, 2000, 3.0, -4, 8, 50, False],
    ...
    ["Fingerprint Emulator", "Anti-Security Tools", 30, 50, 0.2, 35, 70, 60, 450],
    ["Retina Emulator", "Anti-Security Tools", 40, 80, 0.5, 30, 70, 60, 720],
    ["Bio Replicator", "Anti-Security Tools", 40, 100, 0.5, 25, 70, 70, 900],
    ["Microfone Deceiver", "Anti-Security Tools", 20, 20, 0.2, 35, 70, 40, 180],
    ["Camera Deceiver", "Anti-Security Tools", 20, 30, 0.3, 30, 70, 50, 270],
    ["Camera", "Sensors", 0, 50, 0.2, 30, 20, 0, 50],
    ["Microphone", "Sensors", 0, 25, 0.05, 70, 40, 0, 25],
    ["Laser Microphone", "Sensors", 20, 50, 0.3, 30, 30, 30, 50],
    ["Weapon/Cyberware Detector", "Sensors", 20, 250, 2., 0, 20, 40, 250],
    ...
    ["Medkit", "Biotech", 10, 50, 2, 10, 30, 0, 450],
    ["Bio Monitor", "Biotech", 0, 0, 0, 0, 0, 0, False],
    ["Chem Patch", "Biotech", 0, 0, 0, 0, 0, 0, True],
    ["Search", "Programmes", 0, 0, 0, None, None, 0, 100],
    ["Stealth", "Programmes", 30, 0, 0, None, None, 40, 200],
    ["Scan", "Programmes", 0, 0, 0, None, None, 0, 100],
    ["Analyze", "Programmes", 0, 0, 0, None, None, 0, 100],
    ["Access", "Programmes", 0, 0, 0, None, None, 0, 50],
    ["Exploit", "Programmes", 40, 0, 0, None, None, 60, 300],
    ["Crypt", "Programmes", 0, 0, 0, None, None, 20, 100],
    ["Break", "Programmes", 30, 0, 0, None, None, 50, 200],
    ["Edit", "Programmes", 0, 0, 0, None, None, 0, 100],
    ["Control", "Programmes", 0, 0, 0, None, None, 0, 50],
    ["Find", "Programmes", 0, 0, 0, None, None, 0, 100],
    ["Corrupt", "Programmes", 20, 0, 0, None, None, 40, 200],
    ["Medic", "Programmes", 0, 0, 0, None, None, 0, 100],
]
...
closecombatweapons = [
    ...
    ["Baton", "Impact Weapons", 5., '6.94+{Strength}/7.20', "impact", "physical", '5..56+{Strength}/9.', 30., 1, None],
    ...
    ["Mono Whip", "Slashing Weapons", 10., '20.+{Strength}/99999.', "impact", "physical", '20.+{Strength}/99999.', 20., 1, None],
...
rangedweapons = [
    ...
    ["Heavy Pistol", "Pistols", 0., 16., "ballistic", "physical", 15., 12., 5, 0, 0, 50, 30, 10, "", 1, 0, 1, None, 1],
    ["Taser", "Pistols", 0., 5., "impact", "stun", 5., 5., 1, 0, 0, 20, 20, 5, "", 0, 0, 1, None, 1],
    ["Hold-Out Pistol", "Pistols", 0., 8., "ballistic", "physical", 10., 5., 3, 0, 0, 25, 15, 5, "", 0, 0, 1, None, 1],
    ["Light Pistol", "Pistols", 0., 8., "ballistic", "physical", 10., 10., 6, 0, 0, 30, 15, 15, "", 0, 0, 1, None, 1],
    ["Machine Pistol", "Automatics", 0., 8., "ballistic", "physical", 10., 10, 6, 12, 18, 40, 15, 20, "", 1, 0, 1, None, 1],
    ["Sub-Machine-Gun", "Automatics", 0., 8., "ballistic", "physical", 10., 20, 6, 15, 30, 20, 7, 30, "", 1, 0, 1, None, 2],
    ["Shotgun", "Long Rifles", 0., 18., "ballistic", "physical", 20., 30, 5, 0, 0, 40, 15, 6, "", 1, 1, 1, None, 2],
    ["Battle Rifle", "Automatics", 0., 18., "ballistic", "physical", 30., 100, 4, 10, 20, 54, 20, 20, "", 1, 1, 1, # g3
     None, 2],
    ["Assault Rifle", "Automatics", 0., 12., "ballistic", "physical", 20., 80, 5, 12, 18, 36, 12, 30, "", 1, 1, 1, None, 2], #g36
    ["Sport Rifle", "Long Rifles", 0., 12., "ballistic", "physical", 20., 120, 1, 0, 0, 45, 15, 5, "", 1, 1, 1, None, 2],
    ["Sniper Rifle", "Long Rifles", 0., 18., "ballistic", "physical", 30., 160, 2, 0, 0, 60, 15, 10, "", 1, 1, 1, None, 2],
    ["Light MG", "Automatics", 0., 12., "ballistic", "physical", 20., 120, 2, 20, 40, 60, 10, 100, "", 1, 1, 1, None, 2],
    ["Medium MG", "Automatics", 0., 18., "ballistic", "physical", 30., 150, 1, 20, 40, 80, 15, 100, "", 1, 1, 1, None, 2],
    ["Heavy MG", "Automatics", 0., 42., "ballistic", "physical", 76., 300, 1, 30, 50, 180, 25, 100, "", 1, 1, 1, None, 2], #browning m2
    ["Assault Cannon", "Long Rifles", 0., 42., "ballistic", "physical", 76., 300, 1, 0, 0, 120, 25, 5, "", 1, 1, 1, None, 2], #light fifty

    ["Bow", "Archery", 0., '5+{Strength}/10.', "impact", "physical", '5+{Strength}/10.', 30, 1, 1, 1, 30, 0, 0, "", 1, 1, 1, None, 2],
    ["Orc Bow", "Archery", 0., '10+{Strength}/10.', "impact", "physical", '10+{Strength}/10.', 50, 1, 1, 1, 60, 0, 0, "", 1, 1, 1, None, 2],
    ["Troll Bow", "Archery", 0., '15+{Strength}/10.', "impact", "physical", '15+{Strength}/10.', 60, 1, 1, 1, 90, 0, 0, "", 1, 1, 1, None, 2],
    ["Pistol Crossbow", "Archery", 0., 6., "impact", "physical", 6., 10, 1, 1, 1, 26, 0, 0, "", 1, 1, 1, None, 1],
    ["Light Crossbow", "Archery", 0., 10., "impact", "physical", 10., 30, 1, 1, 1, 30, 0, 0, "", 1, 1, 1, None, 2],
    ["Heavy Crossbow", "Archery", 0., 16., "impact", "physical", 16., 48, 1, 1, 1, 40, 0, 0, "", 1, 1, 1, None, 2],
]
...
ware = [
    ...
    ["Cybereyes", "cyberware", 0, 1, 0, 0, "Cybernetic Eye Replacement, Includes Image Link", 0, 2000, 6000, ["Eyes"], [], ''],
    ["High Capcity Cybereyes", "cyberware", 2, 3, 0, 0, "High Capacity Cybernetic Eye Replacement, includes Image Link", 0, 10000, 6000, ["Eyes"], [], ''],
    ["Cyberears", "cyberware", 0, 1, 0, 0, "Cybernetic Ear Replacement, includes Audio Link", 0, 2000, 6000, ["Ears"], [], ''],
    ["High Capacity Cyberears", "cyberware", 2, 3, 0, 0, "High Capacity Cybernetic Ear Replacement, includes Audio Link", 0, 10000, 6000, ["Ears"], [], ''],
    ...
    ["Vehicle Control Rig III", "cyberware", 10, None, 0, 0, "Enables user to interface with rigged Vehicles. Requires Simrig and Internal Simsense Module", 5000, 150000, 6000, ["Vertebrae"],
     [], ''],
    ["Left Cyberarm", "cyberware", 0, 1, 0, 0, "Artificial cyberlimb", 0, 1000, 6000, ["Left Arm"], [], ''],
    ...
    ["Damage Regulator 100%", "bioware", 2, None, 0, 0, "Cybernetic Pain Stimulus Filter", 2500, 122500, 6000, ["Vertebrae"],
     [["stats", "Pain Resistance", "+1."]], ''],
    ["Cyberheart", "cyberware", 5, None, 0, 0, "Cybernetic Heart", 0, 10000, 6000, ["Heart"],
     [["skills", "Athletics", "+10"]], ''],
    ["Synthacardium", "bioware", 5, None, 0, 0, "Bionic Heart", 2000, 2000, 6000, ["Heart"],
     [["skills", "Athletics", "+5"]], ''],
...
fixtures = [
    ...
    ['Video Enhancement III', ['Eyes'], 0.4, 0.12, 0, "Add +15 to Visual Perception skill", [['skills', 'Visual', '+15']], 50000],
    ['Flare Compensation', ['Eyes'], 0.2, 0.06, 0, "Reduce Glare Modifiers by 20 (manual)", [], 750],
    ['Vision Magnification 4x', ['Eyes'], 0.3, 0.09, 0, "Enables user to zoom in and out", [], 6000],
    ['Vision Magnification 8x', ['Eyes'], 0.5, 0.15, 0, "Enables user to zoom in and out", [], 30000 ],
    ['Infrared Vision', ['Eyes'], 0.2, 0.06, 0, "Enables infrared vision", [], 2000],
    ['Low Light Vision', ['Eyes'], 0.2, 0.06, 0, "Enables low light vision", [], 1000 ],
    ['Microscopic Vision', ['Eyes'], 0.4, 0.12, 0, "Enables microscopic vision", [], 3000 ],
    ['Eye Laser System', ['Eyes'], 0, 0, 0.15, "Allows for installation of Eye-Laser subsystems", [], 5000],
    ['Eye Laser Microphone', ['Eyes'], 0, 0.02, 0, "Requires Eye Laser System, works like a Laser Microphone (Range 10 Meters)", [], 5000],
    ['Eye Laser Designator', ['Eyes'], 0, 0, 0, "Requires Eye Laser System, works like a Laser Designator (Range 20 Meters)", [], 4000],
    ['Eye Laser Range Finder', ['Eyes'], 0, 0.01, 0, "Requires Eye Laser System, works like a Range Finder (Range 30 Meters)", [], 1000],
    ['Eye Laser Power Increase', ['Eyes'], 0, 0, 0.2, "Requires Eye Laser System, doubles all ranges and allowes to work as a Tool Laser", [], 5000],
    ['Eye Light System', ['Eyes'], 0, 0., 0.15, "Provides Perfect Vison with Low Light Vision for up to 25 Meters", [], 3000],
    ['Ocular Drones', ['Eyes'], 0, 0.6, 0.35, "Transforms both eyes into ocular drones", [], 20000],
    ['Sound Link', ['Ears'], 0, 0, 0, "Machine to Audio Sense Interface", [], 0],
    ['Enhanced Hearing I', ['Eears'], 0, 0.2, 0.06, "Add +5 to Aural Perception skill", [['skills', 'Aural', '+5']], 1500],
    ['Enhanced Hearing II', ['Eears'], 0, 0.3, 0.09, "Add +10 to Aural Perception skill", [['skills', 'Aural', '+10']], 7500],
    ['Enhanced Hearing III', ['Eears'], 0, 0.4, 0.12, "Add +15 to Aural Perception skill", [['skills', 'Aural', '+15']], 37500],
    ['Select Sound Filter I', ['Eears'], 0, 0.1, 0.03, "Subtract 5 from Environmental Noise Modifiers (manual)", [], 1000],
    ['Select Sound Filter II', ['Eears'], 0, 0.2, 0.06, "Subtract 10 from Environmental Noise Modifiers (manual)", [], 5000],
    ['Select Sound Filter III', ['Eears'], 0, 0.3, 0.09, "Subtract 15 from Environmental Noise Modifiers (manual)", [], 25000],
    ['Damper', ['Ears'], 0.2, 0.06, 0, "Reduce Modifiers due to intense noise by 20 (manual)", [], 750],
    ['Wide Frequency Adaption', ['Ears'], 0.4, 0.12, 0, "Allows users to hear Ultra- and Infrasound", [], 5000],
    ['Balance Augmentor', ['Eears'], 0, 0.5, 0.15, "Add +10 to Balance skill", [['skills', 'Balance', '+10']], 10000],
    ['Hydraulick Jacks', ['Left Leg', 'Right Leg'], 0.75, 0, 0, 'Allows higher and farther jumps using hydraulic technics',
    ...
    ['Light Armor Cover Head', ['Head Skin'], 0.2, 0, 0, '',[['ballistic armor', 'Head', '10']], 500],
    ['Light Armor Cover Torso', ['Upper Torso Skin', 'Lower Torso Skin'], 0.2, 0, 0, 'Provides Ballistic Armor of 10',
    ...
    ['Armor Plating Head', ['Head Skin'], 0.4, 0.5, 0, 'Provides Ballistic and Impact Armor of 30',
     [['ballistic armor', 'Head', '30'],['impact armor', 'Head', '30']], 2000],
    ['Armor Plating Torso', ['Upper Torso Skin', 'Lower Torso Skin'], 0.4, 2., 0, 'Provides Ballistic and Impact Armor of 30',
    ...
    ['Armor Plating Right Arm', ['Right Arm Skin'], 0.4, 1., 0, 'Provides Ballistic and Impact Armor of 30',
     [['ballistic armor', 'Right Arm', '30'],['impact armor', 'Right Arm', '30']], 2000],
    ['Armor Plating Left Arm', ['Left Arm Skin'], 0.4, 1., 0, 'Provides Ballistic and Inpact Armor of 30',
     [['ballistic armor', 'Left Arm', '30'], ['impact armor', 'Left Arm', '30']], 2000],
    ['Armor Plating Right Leg', ['Right Leg Skin'], 0.4, 2., 0, 'Provides Ballistic and Impact Armor of 30',
     [['ballistic armor', 'Right Leg', '30'], ['impact armor', 'Right Leg', '30']], 2000],
    ['Armor Plating Left Leg', ['Left Leg Skin'], 0.4, 2., 0, 'Provides Ballistic and Impact Armor of 30',
     [['ballistic armor', 'Left Leg', '30'], ['impact armor', 'Left Leg', '30']], 2000],
    ['Heavy Armor Plating Head', ['Head Skin'], 0.7, 0.75, 0, 'Provides Ballistic and Impact Armor of 40',
     [['ballistic armor', 'Head', '40'],['impact armor', 'Head', '40']], 4000],
    ['Heavy Armor Plating Torso', ['Upper Torso Skin', 'Lower Torso Skin'], 0.7, 3., 0, 'Provides Ballistic and Impact Armor of 40',
    ...
    ['Heavy Armor Plating Right Arm', ['Right Arm Skin'], 0.7, 1.5, 0, 'Provides Ballistic and Impact Armor of 40',
     [['ballistic armor', 'Right Arm', '40'],['impact armor', 'Right Arm', '40']], 4000],
    ['Heavy Armor Plating Left Arm', ['Left Arm Skin'], 0.7, 1.5, 0, 'Provides Ballistic and Inpact Armor of 40',
     [['ballistic armor', 'Left Arm', '40'], ['impact armor', 'Left Arm', '40']], 4000],
    ['Heavy Armor Plating Right Leg', ['Right Leg Skin'], 0.7, 3., 0, 'Provides Ballistic and Impact Armor of 40',
     [['ballistic armor', 'Right Leg', '40'], ['impact armor', 'Right Leg', '40']], 4000],
    ['Heavy Armor Plating Left Leg', ['Left Leg Skin'], 0.7, 3., 0, 'Provides Ballistic and Impact Armor of 40',
     [['ballistic armor', 'Left Leg', '40'], ['impact armor', 'Left Leg', '40']], 4000],
    ['Retracteable Cyberspurs Right', ['Right Arm'], 0.3, 0, 0, '',[], 1000],
    ['Retracteable Cyberspurs Left', ['Left Arm'], 0.3, 0, 0, '',[], 1000],
    ['Retracteable Cyberclaws Right', ['Right Arm'], 0.05, 0, 0, '',[], 500],
    ['Retracteable Cyberclaws Left', ['Left Arm'], 0.05, 0, 0, '',[], 500],
    ['Hold-Out Cyberpistol Right', ['Right Arm'], 0, 4., 0, '',[], 1000],
    ['Hold-Out Cyberpistol Left', ['Left Arm'], 0, 4., 0, '',[], 1000],
    ['Light Cyberpistol Right', ['Right Arm'], 0, 6., 0, '',[], 1500],
    ['Light Cyberpistol Left', ['Left Arm'], 0, 6., 0, '',[], 1500],
    ['Heavy Cyberpistol Right', ['Right Arm'], 0, 8., 0, '',[], 3000],
    ['Heavy Cyberpistol Left', ['Left Arm'], 0, 8., 0, '',[], 3000],
    ['Cybershotgun Right', ['Right Arm'], 0, 12., 0, '',[], 5000],
    ['Cybershotgun Left', ['Left Arm'], 0, 12., 0, '',[], 5000],
    ['Light Torso External Weapon Mount', ['Upper Torso Bones'], 0, 4., 0, 'Can equip Hold-Out and Light Pistols',[], 4000],
    ['Medium Torso External Weapon Mount', ['Upper Torso Bones'], 0, 5., 0, 'Can equip heavy Pistols and Sub-machine Guns',[], 6000],
    ['Heavy Torso External Weapon Mount', ['Upper Torso Bones'], 0, 7., 0, 'Can equip Shotguns and Assault Rifles',[], 8000],
    ['Light Articulated Weapon Arm', ['Upper Torso Bones'], 0, 6., 0, 'Can equip Hold-Out and Light Pistols',[], 6000],
    ['Medium Articulated Weapon Arm', ['Upper Torso Bones'], 0, 8., 0, 'Can equip Heavy Pistols and Sub-Machine Guns',[], 9000],
    ['Heavy Articulated Weapon Arm', ['Upper Torso Bones'], 0, 10., 0, 'Can equip Shotguns and Assault Rifles',[], 12000],
    ['Hold-Out Cyberholster Right', ['Right Leg'], 0, 7., 0, '',[], 500],
    ['Hold-Out Cyberholster Left', ['Left Leg'], 0, 7., 0, '',[], 500],
    ['Light Pistol Cyberholster Right', ['Right Leg'], 0, 9., 0, '',[], 750],
    ['Light Pistol Cyberholster Left', ['Left Leg'], 0, 9., 0, '',[], 750],
    ['Heavy Pistol Cyberholster Right', ['Right Leg'], 0, 11., 0, '',[], 1000],
    ['Heavy Pistol Cyberholster Left', ['Left Leg'], 0, 11., 0, '',[], 1000],
    ]
