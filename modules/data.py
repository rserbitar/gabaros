...
gameitems = [
    ...
    ["Vibropicker", "Anti-Security Tools", 30, 500, 0.1, 35, 40, 40, False, 0, [], 0, 0.15],
    ["Mini Welder", "Anti-Security Tools", 0, 250, 0.5, 15, 40, 20, False, 0, [], 0, 0.5],
    ["Sequencer", "Anti-Security Tools", 30, 30, 0.1, 35, 70, 60, 270, 0, [], 0, 0.1],
    ["Maglock Passkey", "Anti-Security Tools", 30, 30, 0.1, 35, 70, 60, 270, 0, [], 0, 0.1],
    ["Voice Emulator", "Anti-Security Tools", 30, 30, 0.1, 35, 70, 60, 270, 0, [], 0, 0.1],
    ["Fingerprint Emulator", "Anti-Security Tools", 30, 40, 0.2, 35, 70, 60, 360, 0, [], 0, 0.2],
    ["Retina Emulator", "Anti-Security Tools", 40, 80, 0.5, 30, 70, 60, 720, 0, [], 0, 0.5],
    ["Bio Replicator", "Anti-Security Tools", 40, 100, 0.5, 25, 70, 70, 900, 0, [], 0, 0.5],
    ["Microfone Deceiver", "Anti-Security Tools", 20, 20, 0.2, 35, 70, 40, 80, 0, [], 0, 0.2],
    ["Camera Deceiver", "Anti-Security Tools", 20, 20, 0.3, 30, 70, 50, 80, 0, [], 0, 0.3],
    ["Nano Case Breaker", "Anti-Security Tools", 40, 500, 0.1, 30, 70, 50, False, 0, [], 0, 0.1],
    ["Nano Camera", "Sensors", 0, 300, 0.01, 80, 60, 0, False, 0., [], 0, 0.01],
    ["Micro Camera", "Sensors", 0, 500, 0.2, 30, 20, 0, False, 0.04,
     ["Video Enhancement I", "Video Enhancement II", "Video Enhancement III", "Flare Compensation", "Vision Magnification 4x", "Infrared Vision", "Low Light Vision", "Microscopic Vision"], 0, 0.1],
    ["Mini Camera", "Sensors", 0, 150, 0.2, 30, 20, 0, False, 0.1,
     ["Video Enhancement I", "Video Enhancement II", "Video Enhancement III", "Flare Compensation", "Vision Magnification 4x", "Infrared Vision", "Low Light Vision", "Microscopic Vision"], 0, 0.2],
    ["Camera", "Sensors", 0, 50, 0.2, 30, 20, 0, False, 0.3,
     ["Video Enhancement I", "Video Enhancement II", "Video Enhancement III", "Flare Compensation", "Vision Magnification 4x", "Infrared Vision", "Low Light Vision", "Microscopic Vision"], 0, 0.6],
    ["Nano-Microphone", "Sensors", 0, 100, 0.01, 90, 60, 0, False, 0, [], 0, 0.01],
    ["Mini-Microphone", "Sensors", 0, 150, 0.01, 70, 40, 0, False, 0.1,
    ...
    ["Microphone", "Sensors", 0, 50, 0.08, 70, 40, 0, False, 0.3,
     ["Enhanced Hearing I", "Enhanced Hearing II", "Enhanced Hearing III", "Select Sound Filter I", "Select Sound Filter II", "Select Sound Filter III", "Damper", "Wide Frequency Adaption"], 0, 0.6],
    ["Weapon/Cyberware Detector", "Sensors", 20, 250, 2., 0, 20, 50, 250, 0, [], 0, 2.],
    ["Ultrasound Generator", "Sensors", 10, 100, 0, 0, 0, 0, True, 0, [], 0, 0.2],
    ["Laser Sensor 50m", "Sensors", 0, 100, 0.05, 0, 0, 10, True, 0, [], 0, 0.05],
    ["Laser Sensor 150m", "Sensors", 10, 300, 0.2, 0, 0, 10, True, 0, [], 0, 0.2],
    ["Laser Sensor 500m", "Sensors", 20, 1000, 1, 0, 0, 10, True, 0, [], 0, 1.],
    ["Laser Sensor 2000m", "Sensors",30, 3000, 4, 0, 0, 10, True, 0, [], 0, 4.],
    ["Micro Radar", "Sensors", 40, 2000, 1, 0, 0, 30, False, 0, [], 0., 1],
    ["Mini Radar", "Sensors", 30, 1000, 5, 0, 0, 40, False, 0, [], 0., 5],
    ["Radar", "Sensors", 30, 0, 3000, 50, 0, 50, False, 0, [], 0., 50],
    ["Large Radar", "Sensors", 50, 10000, 500, 0, 0, 60, False, 0, [], 0., 500],
    ["Chem Sniffer", "Sensors", 30, 50, 1., 10, 10, 30, 450, 0, [], 0, 1.],
    ["Light 25m", "Sensors", 0, 200, 0.1, 0, 0, 0, False, 0, [], 0, 0.1],
    ["Light 100m", "Sensors", 0, 100, 0.5, 0, 0, 0, False, 0, [], 0, 0.5],
    ["Light 400m", "Sensors", 0, 500, 2, 0, 0, 0, False, 0, [], 0, 2.],
    ["Light 2000m", "Sensors", 0, 5000, 20, 0, 0, 0, False, 0, [], 0, 20.],
...
rangedweapons = [
    ...
    ["Ranger Arms SM-4",      "Long Rifles", 0., 16., "ballistic", "physical", 24., 160, 2, 0, 0, 60, 20, 15, "", 0, 1, 0, ['Silencer', 'Shock Pad', ('assembly', (3,3))], 2],
    ["Walter MA-2100",        "Long Rifles", 0., 18., "ballistic", "physical", 30., 160, 2, 0, 0, 60, 20, 10, "", 1, 1, 1, ['Smartlink', 'Shock Pad'], 2],
    ...
    ["Ultimax HMG-2",         "Automatics", 0., 36., "ballistic", "physical", 60., 300, 0, 0, 12, 140, 10, 100, "", 1, 1, 1, ['Smartlink', 'Tripod', 'Gas Vent'], 2], #browning m2
...
Agents = [
    ...
    ['Military Drone Pilot Class III', 25, {'Pilot': 40, 'Perception': 30, 'Electronic Warfare': 40, 'Ranged Combat': 30, 'Dodge': 30, 'Stealth': 25, 'Cracking': 20}],
    ]
