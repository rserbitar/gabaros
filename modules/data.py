...
bodyparts = [
    ...
    ["Vertebrae", "human", "Head", 2, 0.2, 0.2, 0.45, 0., 0., 0., 0., ],
...
gameitems = [
    ...
    ["GE Vindicator Minigun", "Ranged Weapon", 70, 12000, 7.5, -10, -45, 80, False, 0, [], 0, 0],
    ...
    ["Erika MCD-1", "Computer", 30, round(rules.deck_cost(*computer_dict["Erika MCD-1"][2:])[-1],0), 2.0, -5, 10, 25, False, 0, [], 0, 0],
    ["Hermes Chariot", "Computer", 35, round(rules.deck_cost(*computer_dict["Hermes Chariot"][2:])[-1],0), 2.0, -5, 10, 25, False, 0, [], 0, 0],
    ["Novatech Navigator", "Computer", 40, round(rules.deck_cost(*computer_dict["Novatech Navigator"][2:])[-1],0), 2.0, -5, 10, 25, False, 0, [], 0, 0],
    ["Renraku Tsurugi", "Computer", 50, round(rules.deck_cost(*computer_dict["Renraku Tsurugi"][2:])[-1],0), 2.0, -5, 10, 25, False, 0, [], 0, 0],
    ["Sony CIY-720", "Computer", 60, round(rules.deck_cost(*computer_dict["Sony CIY-720"][2:])[-1],0),  2.0, -5, 10, 25, False, 0, [], 0, 0],
    ["Fairlight Excalibur", "Computer", 80, round(rules.deck_cost(*computer_dict["Fairlight Excalibur"][2:])[-1],0),  2.0, -5, 10, 25, False, 0, [], 0, 0],
    ["Meta Link", "Computer", 0, round(rules.deck_cost(*computer_dict["Meta Link"][2:])[-1],0),  .1, 40, 40, 0, False, 0, [], 0, 0],
    ["Sony Emperor", "Computer", 5, round(rules.deck_cost(*computer_dict["Sony Emperor"][2:])[-1],0),  .1, 40, 40, 0, False, 0, [], 0, 0],
    ["Renraku Sensei", "Computer", 10, round(rules.deck_cost(*computer_dict["Renraku Sensei"][2:])[-1],0),  .1, 40, 40, 0, False, 0, [], 0, 0],
    ["Erika Elite", "Computer", 15, round(rules.deck_cost(*computer_dict["Erika Elite"][2:])[-1],0),  .1, 40, 40, 0, False, 0, [], 0, 0],
    ["Transys Avalon", "Computer", 30, round(rules.deck_cost(*computer_dict["Transys Avalon"][2:])[-1],0),  .1, 40, 40, 0, False, 0, [], 0, 0],
    ["Fairlight Caliban", "Computer", 40, round(rules.deck_cost(*computer_dict["Fairlight Caliban"][2:])[-1],0),  .1, 40, 40, 0, False, 0, [], 0, 0],
    ...
    ["Optotronics Kit", "Tools", 0, 1000, 3, 10, 50, 0, False, 0, [], 0, 0],
    ["Vibropicker", "Anti-Security Tools", 30, 500, 0.1, 35, 40, 40, False, 0, [], 0, 0],
    ["Mini Welder", "Anti-Security Tools", 0, 250, 0.5, 15, 40, 20, False, 0, [], 0, 0],
    ["Sequencer", "Anti-Security Tools", 30, 30, 0.1, 35, 70, 60, 270, 0, [], 0, 0],
    ["Maglock Passkey", "Anti-Security Tools", 30, 30, 0.1, 35, 70, 60, 270, 0, [], 0, 0],
    ["Voice Emulator", "Anti-Security Tools", 30, 30, 0.1, 35, 70, 60, 270, 0, [], 0, 0],
    ["Fingerprint Emulator", "Anti-Security Tools", 30, 50, 0.2, 35, 70, 60, 450, 0, [], 0, 0],
    ["Retina Emulator", "Anti-Security Tools", 40, 80, 0.5, 30, 70, 60, 720, 0, [], 0, 0],
    ["Bio Replicator", "Anti-Security Tools", 40, 100, 0.5, 25, 70, 70, 900, 0, [], 0, 0],
    ["Microfone Deceiver", "Anti-Security Tools", 20, 20, 0.2, 35, 70, 40, 180, 0, [], 0, 0],
    ["Camera Deceiver", "Anti-Security Tools", 20, 30, 0.3, 30, 70, 50, 270, 0, [], 0, 0],
    ["Micro Camera", "Sensors", 0, 50, 0.2, 30, 20, 0, 50, 0, [], 0, 0],
    ["Mini Camera", "Sensors", 0, 50, 0.2, 30, 20, 0, 50, 0, [], 0, 0],
    ["Camera", "Sensors", 0, 50, 0.2, 30, 20, 0, 50, 0, [], 0, 0],
    ["Microphone", "Sensors", 0, 25, 0.05, 70, 40, 0, 25, 0, [], 0, 0],
    ["Laser Microphone", "Sensors", 20, 50, 0.3, 30, 30, 40, 50, 0, [], 0, 0],
    ["Weapon/Cyberware Detector", "Sensors", 20, 250, 2., 0, 20, 50, 250, 0, [], 0, 0],
    ["Ultrasound", "Sensors", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Laser Sensor 50m", "Sensors", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Laser Sensor 150m", "Sensors", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Laser Sensor 500m", "Sensors", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Laser Sensor 2000m", "Sensors", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Micro Radar", "Sensors", 0, 0, 0, 0, 0, 0, False, 0, [], 0., 10],
    ["Mini Radar", "Sensors", 0, 0, 0, 0, 0, 0, False, 0, [], 0., 10],
    ["Radar", "Sensors", 0, 0, 0, 0, 0, 0, False, 0, [], 0., 10],
    ["Large Radar", "Sensors", 0, 0, 0, 0, 0, 0, False, 0, [], 0., 10],
    ["Chem Sniffer", "Sensors", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Flashlight", "Survival", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Flashlight Infrared", "Survival", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Flashlight UV", "Survival", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Respirator", "Survival", 0, 0, 0, 0, 0, 0, True, 0, [], 0, 0],
    ["Rebreather", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Climbing Gear", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Diving Gear", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Urban Survival Kit", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Outdoors Survival Kit", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Micro Winch (10kg)", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Standard Winch (100kg)", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Large Winch (250kg)", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["XXL Winch (500kg)", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Microwire (20m)", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Stealth Wire (20m)", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Myomeric Rope (20m)", "Survival", 0, 0, 0, 0, 0, 0, False, 0, [], 0, 0],
    ["Medkit", "Biotech", 10, 50, 3, 10, 30, 0, 450, 0, [], 0, 0],
    ["Bio Monitor", "Biotech", 20, 500, 1, 30, 30, 0, False, 0, [], 0, 0],
    ["Chem Patch", "Biotech", 0, 50, 0.1, 50, 100, 0, False, 0, [], 0, 0],
    ...
    ["Rifle Scope", "Output Devices", Availability, Cost, Weight, Wis_stealth, Scan_stealth, legality, False, 0.4,
     ["Video Enhancement I", "Video Enhancement II", "Video Enhancement III", "Flare Compensation", "Vision Magnification 4x", "Infrared Vision", "Low Light Vision", "Microscopic Vision"], 0, 0],
    ["Earbuds", "Output Devices", Availability, Cost, Weight, Wis_stealth, Scan_stealth, legality, False, 0.04, [], 0, 0],
    ["Headphones", "Output Devices", Availability, Cost, Weight, Wis_stealth, Scan_stealth, legality, False, 0.3, [], 0, 0],
    ...
    ["Antidode I", "Drugs & Toxins", 0, 100, 0.02, 50, 10, 0, False, 0, [], 0, 0],
    ["Antidode II", "Drugs & Toxins", 30, 1000, 0.02, 50, 10, 0, False, 0, [], 0, 0],
    ["Antidode III", "Drugs & Toxins", 60, 5000, 0.02, 50, 10, 0, False, 0, [], 0, 0],
    ["Stim", "Drugs & Toxins", 20, 200, 0.02, 50, 10, 20, False, 0, [], 0, 0],
    ["Elysium", "Drugs & Toxins", 40, 300, 0.02, 50, 70, 60, False, 0, [], 0, 0],
    ["Oblivion", "Drugs & Toxins", 30, 200, 0.02, 50, 10, 50, False, 0, [], 0, 0],
    ["Joy", "Drugs & Toxins", 40, 500, 0.02, 50, 60, 60, False, 0, [], 0, 0],
    ["Truth", "Drugs & Toxins", 50, 1000, 0.02, 50, 30, 40, False, 0, [], 0, 0],

    ["Neuro-Stun", "Drugs & Toxins", 30, 200, 0.02, 50, 40, 40, False, 0, [], 0, 0],
    ["Neuro-Stun X", "Drugs & Toxins", 35, 400, 0.02, 50, 30, 50, False, 0, [], 0, 0],
    ["Narcojet", "Drugs & Toxins", 20, 50, 0.02, 50, 20, 30, False, 0, [], 0, 0],
    ["Seven-7", "Drugs & Toxins", 60, 1000, 0.02, 50, 40, 70, False, 0, [], 0, 0],
    ["Gamma-Skopolamine", "Drugs & Toxins", 60, 2000, 0.02, 50, 0, 50, False, 0, [], 0, 0],
    ["Nausea-Gas", "Drugs & Toxins", 10, 50, 0.02, 50, 20, 10, False, 0, [], 0, 0],
    ...
    ["Activesoft: Impact Weapons", "Skillsoft", 30, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Piercing Weapons", "Skillsoft", 30, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Slashing Weapons", "Skillsoft", 30, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Brawling", "Skillsoft", 20, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Wrestling", "Skillsoft", 20, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Aerodynamic", "Skillsoft", 20, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Axes", "Skillsoft", 20, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Balls", "Skillsoft", 20, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Archery", "Skillsoft", 30, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Pistols", "Skillsoft", 30, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Automatics", "Skillsoft", 40, 0, None, None, None, 50, 6000, 0, [], 0, 0],
    ["Activesoft: Long Rifle", "Skillsoft", 30, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Indirect Fire", "Skillsoft", 40, 0, None, None, None, 70, 6000, 0, [], 0, 0],
    ["Activesoft: Launch Weapons", "Skillsoft", 40, 0, None, None, None, 70, 6000, 0, [], 0, 0],
    ["Activesoft: Spray Weapons", "Skillsoft", 20, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Balance", "Skillsoft", 10, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Dodge", "Skillsoft", 10, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Climbing", "Skillsoft", 0, 0, None, None, None, 0, 3000, 0, [], 0, 0],
    ["Activesoft: Jumping", "Skillsoft", 0, 0, None, None, None, 0, 3000, 0, [], 0, 0],
    ["Activesoft: Lifting", "Skillsoft", 0, 0, None, None, None, 0, 3000, 0, [], 0, 0],
    ["Activesoft: Running", "Skillsoft", 0, 0, None, None, None, 0, 3000, 0, [], 0, 0],
    ["Activesoft: Swimming", "Skillsoft", 0, 0, None, None, None, 0, 3000, 0, [], 0, 0],
    ["Activesoft: Dancing", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Singing", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Hiding", "Skillsoft", 30, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Shadowing", "Skillsoft", 30, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Sneaking", "Skillsoft", 30, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Lockpicking", "Skillsoft", 40, 0, None, None, None, 50, 6000, 0, [], 0, 0],
    ["Activesoft: Pickpocketing", "Skillsoft", 40, 0, None, None, None, 50, 6000, 0, [], 0, 0],
    ["Activesoft: Quickdrawing", "Skillsoft", 20, 0, None, None, None, 30, 6000, 0, [], 0, 0],
    ["Activesoft: Painting", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Sculpting", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Theatrical", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Impersonation", "Skillsoft", 30, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Animal Riding", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Airplaine", "Skillsoft", 20, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Hovercraft", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Helicopter", "Skillsoft", 10, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Submarine", "Skillsoft", 10, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Thrust", "Skillsoft", 20, 0, None, None, None, 40, 6000, 0, [], 0, 0],
    ["Activesoft: Watercraft", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],
    ["Activesoft: Wheeled", "Skillsoft", 0, 0, None, None, None, 0, 6000, 0, [], 0, 0],

    ["Passivesoft: Orientation", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Land", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Sea", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Space", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Air", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Aural", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Olfactorial", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Tactile", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Visual", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Guess Intentions", "Skillsoft", 20, 0, None, None, None, 30, 4000, 0, [], 0, 0],
    ["Passivesoft: Detect Deceit", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Interrogtion", "Skillsoft", 10, 0, None, None, None, 50, 4000, 0, [], 0, 0],
    ["Passivesoft: Convince", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Instruction", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Negotiation", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Deception", "Skillsoft", 10, 0, None, None, None, 50, 4000, 0, [], 0, 0],
    ["Passivesoft: Intimidation", "Skillsoft", 10, 0, None, None, None, 50, 4000, 0, [], 0, 0],
    ["Passivesoft: Leadership", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Persuasion", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Oratory", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Data Search", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Programming", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Computer Use", "Skillsoft", 0, 0, None, None, None, 0, 8000, 0, [], 0, 0],
    ["Passivesoft: Cracking", "Skillsoft", 20, 0, None, None, None, 70, 8000, 0, [], 0, 0],
    ["Passivesoft: Cybercombat", "Skillsoft", 30, 0, None, None, None, 50, 4000, 0, [], 0, 0],
    ["Passivesoft: Decryption", "Skillsoft", 30, 0, None, None, None, 70, 4000, 0, [], 0, 0],
    ["Passivesoft: Security", "Skillsoft", 0, 0, None, None, None, 0, 8000, 0, [], 0, 0],
    ["Passivesoft: Toxins", "Skillsoft", 10, 0, None, None, None, 30, 4000, 0, [], 0, 0],
    ["Passivesoft: Demolitions", "Skillsoft", 20, 0, None, None, None, 50, 4000, 0, [], 0, 0],
    ["Passivesoft: Maglocks", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Sensors", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Optical Computers", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Electronic Warfare", "Skillsoft", 20, 0, None, None, None, 40, 4000, 0, [], 0, 0],
    ["Passivesoft: Locks", "Skillsoft", 10, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Weapons", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Traps", "Skillsoft", 20, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Cybernetics", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Extended Care", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: First Aid", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Disguise", "Skillsoft", 10, 0, None, None, None, 40, 4000, 0, [], 0, 0],
    ["Passivesoft: Forgery", "Skillsoft", 20, 0, None, None, None, 50, 4000, 0, [], 0, 0],
    ["Passivesoft: Ground Vehicle Mechanics", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Airborne Vehicle Mechanics", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Spacecraft Vehicle Mechanics", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ["Passivesoft: Watercraft Vehicle Mechanics", "Skillsoft", 0, 0, None, None, None, 0, 4000, 0, [], 0, 0],
    ...
    ["Vision Magnification 4x", "Upgrade", 1000, 0, None, None, None, 0, False, 0, [], 0.15, 0.05],
    ["Vision Magnification 8x", "Upgrade", 2500, 0, None, None, None, 0, False, 0, [], 0.15, 0.15],
    ["Vision Magnification 16x", "Upgrade", 5000, 0, None, None, None, 0, False, 0, [], 0.15, 0.5],
    ["Vision Magnification 32x", "Upgrade", 10000, 0, None, None, None, 0, False, 0, [], 0.15, 1.5],
    ...
    ["Enhandec Hearing III", "Upgrade", 50, 37500, None, None, None, 20, False, 0, [], 0.2, 0.04],
...
closecombatweapons = [
    ...
    ["Chainsaw", "Slashing Weapons", 0., '18.+{Strength}/5.', "impact", "physical", '6.+{Strength}/15.', 45., 1, None],
]
...
rangedweapons = [
    ...
    ["Colt America L36",      "Pistols", 0., 8., "ballistic", "physical", 10., 10., 2, 0, 0, 30, 15, 11, "", 1, 0, 1, ['Laser Sight 50m'], 1],
    ["Fichetti Security 600", "Pistols", 0., 8., "ballistic", "physical", 10., 10., 2, 0, 0, 30, 15, 20, "", 1, 0, 1, ['Laser Sight 50m'], 1],
    ["Hammerli 620S",         "Pistols", 0., 8., "ballistic", "physical", 10., 12., 2, 0, 0, 30, 13, 6, "", 1, 0, 1, ['Smartlink', 'Gas Vent'], 1],
    ["Yamaha Sakura Fubuki",  "Pistols", 0., 8., "ballistic", "physical", 10., 9., 4, 0, 0, 30, 8, 40, "", 1, 0, 1, ['Smartlink'], 1],
    ...
    ["Ares Predator",         "Pistols", 0., 16., "ballistic", "physical", 15., 12., 2, 0, 0, 50, 30, 15, "", 1, 0, 1, ['smartlink'], 1],
    ["Ares Viper Slivergun",  "Pistols", 0., 20., "ballistic", "physical", 6., 11., 2, 3, 0, 45, 30, 20, "", 1, 0, 1, ['Silencer'], 1],
    ["Colt Manhunter",        "Pistols", 0., 16., "ballistic", "physical", 15., 12., 2, 0, 0, 50, 30, 16, "", 1, 0, 1, ['Laser Sight 50m'], 1],
    ...
    ["HK-227X",               "Automatics", 0., 8., "ballistic", "physical", 10., 20, 2, 3, 8, 25, 10, 28, "", 1, 0, 1, ['Silencer', 'Smartlink', "Gas Vent"], 2],
    ["HK MP-5 TX",            "Automatics", 0., 8., "ballistic", "physical", 10., 20, 2, 3, 7, 25, 10, 20, "", 1, 0, 1, ['Laser Sight 50m', "Gas Vent"], 2],
    ["Ingram Smartgun X",     "Automatics", 0., 8., "ballistic", "physical", 10., 20, 0, 3, 8, 25, 10, 32, "", 1, 0, 1, ['Silencer', 'Smartlink'], 2],
    ["Uzi IV",                "Automatics", 0., 8., "ballistic", "physical", 10., 20, 0, 3, 0, 25, 10, 24, "", 1, 0, 1, ['Laser Sight 50m'], 2],
    ...
    ["Ares Alpha",            "Automatics", 0., 12., "ballistic", "physical", 20., 80, 2, 3, 8, 36, 8, 42, "", 1, 1, 1, ['Underbarrel Grenadelauncher', 'Smartlink'], 2],
    ["FN HAR",                "Automatics", 0., 12., "ballistic", "physical", 20., 80, 2, 3, 8, 36, 10, 35, "", 1, 1, 1, ['Laser Sight 150m', 'Gas Vent'], 2],
    ["Ruger 100",             "Long Rifles", 0., 12., "ballistic", "physical", 20., 120, 2, 0, 0, 45, 20, 5, "", 0, 1, 1, ['Shock Pad'], 2],
    ["PJSS Elephant Rifle",   "Long Rifles", 0., 18., "ballistic", "physical", 30., 100, 1, 2, 0, 50, 20, 2, "", 1, 1, 1, ['Shock Pad'], 2],
    ["Ranger Arms SM-4",      "Long Rifles", 0., 16., "ballistic", "physical", 24., 160, 2, 0, 0, 55, 20, 15, "", 0, 1, 0, ['Silencer', 'Shock Pad', ('assembly', (3,3))], 2],
    ["Walter MA-2100",        "Long Rifles", 0., 18., "ballistic", "physical", 30., 160, 2, 0, 0, 55, 20, 10, "", 1, 1, 1, ['Smartlink', 'Shock Pad'], 2],
    ["Ingram White Knight",   "Automatics", 0., 12., "ballistic", "physical", 20., 120, 2, 4, 12, 55, 10, 100, "", 0, 0, 0, ['Smartlink', 'Gas Vent', 'Shock Pad'], 2],
    ["GE Vindicator Minigun", "Automatics", 0., 12., "ballistic", "physical", 20., 120, 0, 0, 16, 70, 8, 100, "", 0, 0, 0, ['Smartlink', 'Gas Vent', 'Shock Pad', ('power-up', 1)], 2],
    ["Stoner-Ares M202",      "Automatics", 0., 18., "ballistic", "physical", 30., 150, 0, 0, 12, 80, 10, 100, "", 1, 1, 1, ['Smartlink',], 2],
    ["Ultimax HMG-2",         "Automatics", 0., 36., "ballistic", "physical", 60., 300, 0, 0, 12, 180, 10, 100, "", 1, 1, 1, ['Smartlink', 'Tripod', 'Gas Vent'], 2], #browning m2
    ["Panther XXL",           "Long Rifles", 0., 36., "ballistic", "physical", 60., 300, 1, 0, 0, 100, 20, 15, "", 1, 1, 1, ['Smartlink'], 2], #light fifty
    ["Ares Thunderstruck Gauss Rifle", "Long Rifles", 0., 30., "ballistic", "physical", 72., 320, 2, 0, 0, 100, 20, 10, "", 1, 1, 1, ['Smartlink', 'Shock Pad'], 2], #light fifty
...
ware = [
    ...
    ["Datajack", "cyberware", 1, None, 0, 0, "A wired and wireless connection to headware", 0, 250, 0, [], [], 'Brain'],
    ...
    ["Knowledge-Link", "cyberware", 15, None, 0, 0, "Machine to Raw Thoughts/Knowledge Interface, allowes 1 concurrent Knowsofts of unlimited Rating", 0, 30000, 0, [],
    ...
    ["Skillsoft Driver 45", "cyberware", 20, None, 0, 0, "Skill Driver System, allowes a maximum of 2 concurrent Passivesofts with Rating 45", 3000, 75000, 0,
     [], [], 'Brain'],
    ["Skillsoft Expert System", "cyberware", 10, None, 0, 0, "Skill Expert System, adds +5 Rating to all Active/Passive/Knowsoft Ratings", 5000, 50000, 0,
     [], [], 'Brain'],
    ["Skillsoft Compression System", "cyberware", 5, None, 0, 0, "Skill Compression System, allows 2 more concurrent Active/Passive/Knowsoft", 5000, 5000, 0,
     [], [], 'Brain'],
    ["Transducer", "cyberware", 2, None, 0, 0, "Vocal Thoughts to Machine Interface", 0, 1000, 0, [], [], 'Brain'],
    ["Simrig", "cyberware", 5, None, 0, 0, "Senses/Motoric Triggers to Machine Interface", 0, 5000, 0, [], [], 'Brain'],
    ["Transscriber", "cyberware", 8, None, 0, 0, "Raw Thoughts to Machine Interface", 0, 20000, 0, [], [], 'Brain'],
    ["Encephalon I", "cyberware", 7, None, 0, 0, "Cybernetic Logic-Processing Unit", 0, 6000, 0, [],
     [["attributes", "Logic", "+10"]], 'Brain'],
    ["Encephalon II", "cyberware", 14, None, 0, 0, "Cybernetic Logic-Processing Unit", 0, 30000, 0, [],
     [["attributes", "Logic", "+20"]], 'Brain'],
    ["Encephalon III", "cyberware", 21, None, 0, 0, "Cybernetic Logic-Processing Unit", 0, 150000, 0, [],
     [["attributes", "Logic", "+30"]], 'Brain'],
    ["Sensor Coprocessor I", "cyberware", 7, None, 0, 0, "Cybernetic Sensor Coprocessor", 0, 6000, 0, [],
     [["attributes", "Intuition", "+10"]], 'Brain'],
    ["Sensor Coprocessor II", "cyberware", 14, None, 0, 0, "Cybernetic Sensor Coprocessor", 0, 30000, 0, [],
     [["attributes", "Intuition", "+20"]], 'Brain'],
    ["Sensor Coprocessor III", "cyberware", 21, None, 0, 0, "Cybernetic Sensor Coprocessor", 0, 150000, 0, [],
     [["attributes", "Intuition", "+30"]], 'Brain'],
    ["Emotion Control Filter I", "cyberware", 7, None, 0, 0, "Cybernetic Processing Filter", 0, 6000, 0, [],
     [["attributes", "Willpower", "+10"]], 'Brain'],
    ["Emotion Control Filter II", "cyberware", 14, None, 0, 0, "Cybernetic Processing Filter", 0, 30000, 0, [],
     [["attributes", "Willpower", "+20"]], 'Brain'],
    ["Emotion Control Filter III", "cyberware", 21, None, 0, 0, "Cybernetic Processing Filter", 0, 150000, 0, [],
     [["attributes", "Willpower", "+30"]], 'Brain'],
    ["Cerebral Booster I", "bioware", 7, None, 0, 0, "Bionetic Cortex Enhancement", 6000, 6000, 0, [],
     [["attributes", "Logic", "+10"]], 'Brain'],
    ["Cerebral Booster II", "bioware",14, None, 0, 0, "Bionetic Cortex Enhancement", 6000, 48000, 0, [],
     [["attributes", "Logic", "+20"]], 'Brain'],
    ["Cerebral Booster III", "bioware", 21, None, 0, 0, "Bionetic Cortex Enhancement", 6000, 294000, 0, [],
     [["attributes", "Logic", "+30"]], 'Brain'],
    ["Thalamus Enhancer I", "bioware", 7, None, 0, 0, "Bionetic Thalamus Enhancement", 6000, 6000, 0, [],
     [["attributes", "Intuition", "+10"]], 'Brain'],
    ["Thalamus Enhancer II", "bioware", 14, None, 0, 0, "Bionetic Thalamus Enhancement", 6000, 42000, 0, [],
     [["attributes", "Intuition", "+20"]], 'Brain'],
    ["Thalamus Enhancer III", "bioware", 21, None, 0, 0, "Bionetic Thalamus Enhancement", 6000, 294000, 0, [],
     [["attributes", "Intuition", "+30"]], 'Brain'],
    ["Lymbic Filter I", "bioware", 7, None, 0, 0, "Bionetic Lymbic Filter System", 6000, 6000, 0, [],
     [["attributes", "Willpower", "+10"]], 'Brain'],
    ["Lymbic Filter I", "bioware", 14, None, 0, 0, "Bionetic Lymbic Filter System", 6000, 42000, 0, [],
     [["attributes", "Willpower", "+20"]], 'Brain'],
    ["Lymbic Filter III", "bioware", 21, None, 0, 0, "Bionetic Lymbic Filter System", 6000, 294000, 0, [],
     [["attributes", "Willpower", "+30"]], 'Brain'],
    ...
    ["Sleep Regulator", "bioware", 5, None, 0, 0, "Sleep Regulator", 2500, 5000, 0, [],
     [], 'Brain'],
    ["Trauma Damper", "bioware", 6, None, 0, 0, "Reduce effective stun damage by 30%", 4000, 26000, 0, [],
     [['stats', 'Stun Damage Reduction', '*0.70']], 'Brain'],
    ["Voice Modulator", "cyberware", 5, None, 0, 0, "Enables the user to change the tone of his voice", 0, 5000, 0, [],
    ...
    ["Auto Injector", "cyberware", 5, None, 0, 0, "Can inject up to 6 doses of drugs/toxins on defined triggers. Halve the speed of the compound.", 0, 1000, 0, [],
     [], 'Neck'],
    ["Skinlink", "cyberware", 3, None, 0, 0, "Allowes low bandwidth connections over skin", 0, 3000, 0, [],
     [], 'Skin'],
    ["Biomonitor", "cyberware", 5, None, 0, 0, "Detailed bio information of the user. +10 on Medic Tests if user is target.", 0, 3000, 0, [],
     [], 'Torso'],
    ...
    ["High Capacity Left Cyberarm", "cyberware", 0, 1, 0, 0, "Artificial cyberlimb", 5000, 2000, 7000, ["Left Arm"], [], ''],
    ["High Capacity Right Cyberarm", "cyberware", 0, 1, 0, 0, "Artificial cyberlimb", 5000, 2000, 7000, ["Right Arm"], [], ''],
    ["High Capacity Left Cyberleg", "cyberware", 0, 1, 0, 0, "Artificial cyberlimb", 5000, 2000, 7000, ["Left Leg"], [], ''],
    ["High Capacity Right Cyberleg", "cyberware", 0, 1, 0, 0, "Artificial cyberlimb", 5000, 2000, 7000, ["Right Leg"], [], ''],
    ["Left Raptor Cyberleg", "cyberware", 0, 0.8, 0, 0, "Artificial cyberlimb", 5000, 2000, 6000, ["Left Leg"],
     [['stats', 'Running Speed', '*1.5'], ['stats', 'Sprinting Speed', '*1.5'], ['stats','Running Jump Vertical', '*1.5'], ['stats','Running Jump Horizontal', '*1.5']], ''],
    ["Right Raptor Cyberleg", "cyberware", 0, 0.8, 0, 0, "Artificial cyberlimb", 5000, 2000, 6000, ["Right Leg"],
     [['stats', 'Running Speed', '*1.5'], ['stats', 'Sprinting Speed', '*1.5'], ['stats','Running Jump Vertical', '*1.5'], ['stats','Running Jump Horizontal', '*1.5']], ''],
    ...
    ["High Capacity Torso Shell", "cyberware", 0, 1, 0, 0, "Artificial Cybertorso", 5000, 8000, 7000,
     ["Upper Torso Bones", "Upper Torso Muscles", "Upper Torso Nerves", "Upper Torso Skin",
      "Lower Torso Bones", "Lower Torso Muscles", "Lower Torso Nerves", "Lower Torso Skin",], [], ''],
    ...
    ["Bone Lacing Total", "cyberware", 0, None, 0, 0, "Cybernetic bone lacing", 0, 0, 6000,
     ["Left Leg Bones", "Right Leg Bones", "Lower Torso Bones",
      "Left Arm Bones", "Right Arm Bones", "Upper Torso Bones"], [], ''],
    ["Wired Reflexes I", "cyberware", 10, None, 0, 0, "Cybernetic nerve replacement", 5000, 5000, 6000,
     ["Vertebrae"], [['stats', 'Physical Reaction', '+10'], ['stats', 'Physical Action Multiplyer', '*0.9']], ''],
    ["Wired Reflexes II", "cyberware", 20, None, 0, 0, "Cybernetic nerve replacement", 5000, 25000, 6000,
    ...
    ["Wired Reflexes III", "cyberware", 30, None, 0, 0, "Cybernetic nerve replacement", 5000, 125000, 6000,
    ...
    ["Skillwires 25", "cyberware", 5, None, 0, 0, "Skill Driver System, allowes a maximum of 2 concurrent Activesofts with Rating 25", 4000, 4000, 6000,
     ["Vertebrae", "Upper Torso Nerves", "Left Arm Nerves", "Right Arm Nerves", "Lower Torso Nerves", "Left Leg Nerves",
      "Right Leg Nerves"], [], ''],
    ["Skillwires 35", "cyberware", 7, None, 0, 0, "Skill Driver System, allowes a maximum of 2 concurrent Activesofts with Rating 35", 4000, 20000, 6000,
     ["Vertebrae", "Upper Torso Nerves", "Left Arm Nerves", "Right Arm Nerves", "Lower Torso Nerves", "Left Leg Nerves",
      "Right Leg Nerves"], [], ''],
    ["Skillwires 45", "cyberware", 10, None, 0, 0, "Skill Driver System, allowes a maximum of 2 concurrent Activesofts with Rating 45", 4000, 100000, 6000,
     ["Vertebrae", "Upper Torso Nerves", "Left Arm Nerves", "Right Arm Nerves", "Lower Torso Nerves", "Left Leg Nerves",
      "Right Leg Nerves"], [], ''],
    ["Synaptic Accelerator I", "bioware", 10, None, 0, 0, "Bionetic nerve replacement", 15000, 5000, 6000,
     ["Vertebrae"], [ ['stats', 'Physical Reaction', '+10'], ['stats', 'Physical Action Multiplyer', '*0.9']], ''],
    ["Synaptic Accelerator II", "bioware", 20, None, 0, 0, "Bionetic nerve replacement",15000, 35000, 6000,
     ["Vertebrae", "Upper Torso Nerves", "Left Arm Nerves", "Right Arm Nerves"],
     [['stats', 'Physical Reaction', '+20'], ['stats', 'Physical Action Multiplyer', '*0.8']], ''],
    ["Synaptic Accelerator III", "bioware", 30, None, 0, 0, "Bionetic nerve replacement", 15000, 245000, 6000,
     ["Vertebrae", "Upper Torso Nerves", "Left Arm Nerves", "Right Arm Nerves", "Lower Torso Nerves", "Left Leg Nerves",
      "Right Leg Nerves"],
     [['stats', 'Physical Reaction', '+30'], ['stats', 'Physical Action Multiplyer', '*0.7']], ''],
    ["Damage Compensator 33%", "cyberware", 1, None, 0, 0, "Cybernetic Pain Stimulus Filter", 0, 2500, 6000, ["Vertebrae"],
     [["stats", "Pain Resistance", "+0.33"]], ''],
    ["Damage Compensator 66%", "cyberware", 1.5, None, 0, 0, "Cybernetic Pain Stimulus Filter", 0, 12500, 6000, ["Vertebrae"],
     [["stats", "Pain Resistance", "+0.66"]], ''],
    ["Damage Compensator 100%", "cyberware", 2, None, 0, 0, "Cybernetic Pain Stimulus Filter", 0, 62500, 6000, ["Vertebrae"],
     [["stats", "Pain Resistance", "+1."]], ''],
    ["Damage Regulator 33%", "bioware", 1, None, 0, 0, "Bilogical Pain Stimulus Filter", 2500, 2500, 6000, ["Vertebrae"],
     [["stats", "Pain Resistance", "+0.33"]], ''],
    ["Damage Regulator 66%", "bioware", 1.5, None, 0, 0, "Cybernetic Pain Stimulus Filter", 2500, 17500, 6000, ["Vertebrae"],
     [["stats", "Pain Resistance", "+0.66"]], ''],
    ["Damage Regulator 100%", "bioware", 2, None, 0, 0, "Cybernetic Pain Stimulus Filter", 2500, 122500, 6000, ["Vertebrae"],
     [["stats", "Pain Resistance", "+1."]], ''],
    ...
    ["Orthoskin", "bioware", 0, None, 0, 0, "Bionetic Dermal Armor", 20000, 20000, 6000,
     ...
     [], [['skills', 'Balance', '+20']], 'Spine'],
     ["Biomonitor", "cyberware", 5, None, 0, 0, "Monitors all body functions. Makes all damage and wound information available. Add +20 to any Medics Test on user", 0, 3000, 0,
     [], [], 'Body'],
     ["Platelet Factory", "bioware", 5, None, 0, 0, "Reduces bleeding due to wounds by half", 0, 6000, 0,
...
fixtures = [
    ...
    ['Flare Compensation', ['Eyes'], 0.1, 0.02, 0, "Reduce Glare Modifiers by 20 (manual)", [], 750],
    ...
    ['Microscopic Vision', ['Eyes'], 0.2, 0.06, 0, "Enables microscopic vision", [], 3000 ],
    ['Eye Laser System', ['Eyes'], 0, 0, 0.05, "Allows for installation of Eye-Laser subsystems", [], 5000],
    ['Eye Laser Microphone', ['Eyes'], 0, 0.01, 0, "Requires Eye Laser System, works like a Laser Microphone (Range 20 Meters)", [], 2000],
    ['Eye Laser Designator', ['Eyes'], 0, 0, 0.01, "Requires Eye Laser System, works like a Laser Designator (Range 30 Meters)", [], 1500],
    ['Eye Laser Range Finder', ['Eyes'], 0, 0.005, 0, "Requires Eye Laser System, works like a Range Finder (Range 50 Meters)", [], 500],
    ['Eye Laser Power Increase', ['Eyes'], 0, 0.15, 0, "Requires Eye Laser System, triples all ranges and allowes to work as a Tool Laser", [], 5000],
    ['Eye Light System', ['Eyes'], 0., 0.07, 0, "Provides Perfect Vison with Low Light Vision for up to 25 Meters", [], 3000],
    ...
    ['Ultrasound Generator', ['Head Bones'], 0.1, 0.5, 0, "Generates Ultrasound waves. Needed for Ultrasound system.", [], 2000],
    ...
    ['Light Torso External Weapon Mount', ['Upper Torso Bones'], 0, 3., 0, 'Can equip weapons with 1-handed minimum strength of 30. 120 degree FOV.',[], 4000],
    ['Medium Torso External Weapon Mount', ['Upper Torso Bones'], 0, 4., 0, 'Can equip weapons with 1/2-handed minimum strength of 45/30. 120 degree FOV.',[], 6000],
    ['Heavy Torso External Weapon Mount', ['Upper Torso Bones'], 0, 5., 0, 'Can equip weapons with 1/2-handed minimum strength of 55/40. 120 degree FOV.',[], 8000],
    ['Light Articulated Weapon Arm', ['Upper Torso Bones'], 0, 4., 0, 'Can equip weapons with 1-handed minimum strength of 30. 360 degree FOV.',[], 6000],
    ['Medium Articulated Weapon Arm', ['Upper Torso Bones'], 0, 6., 0, 'Can equip weapons with 1/2-handed minimum strength of 45/30. 360 degree FOV.',[], 9000],
    ['Heavy Articulated Weapon Arm', ['Upper Torso Bones'], 0, 8., 0, 'Can equip weapons with 1/2-handed minimum strength of 55/40. 360 degree FOV.',[], 12000],
    ...
    ['Internal Commlink Right Arm', ['Right Arm'], 0, .2, 0, 'Commlink has to be purchased seperately',[], 1000],
    ['Internal Commlink Left Arm', ['Left Arm'], 0, .2, 0, 'Commlink has to be purchased seperately',[], 1000],
    ['Internal Commlink Right Leg', ['Right Leg'], 0, .2, 0, 'Commlink has to be purchased seperately',[], 1000],
    ['Internal Commlink Left Leg', ['Left Leg'], 0, .2, 0, 'Commlink has to be purchased seperately',[], 1000],
    ]
...
adept_powers = [
    ...
    ["Danger Sense", 'X', 'Enhance Reaction for suprise tests (Manual)', [['Physical Reaction in Surprise Tests +', '{Value}**0.5*{Magic}/5.']], [['test', 'Surprise', '+{Value}**0.5*{Magic}/5.']]],
...
vehicle_chassis = [
    ...
    ['Wheeled Dog', 20, 20, 2, 20, 0.5, 40, 40],
    ['Steel Lynx', 100, 35, 3, 100, 1, 40, 50],
    ...
    ['Segway', 30, 12, 1, 100, 1., 30, 0],
    ['Personal Mobility Vehicle', 100, 20, 2, 100, 2., 30, 5],
    ['Google Car', 500, 30, 2, 300, 2.5, 40, 10],
    ['Subcompact', 750, 50, 3, 350, 4.5, 40, 10], # opel insignia
    ['Speed Car', 1500, 85, 5, 300, 4.5, 40, 10],
    ['Sedan', 1500, 50, 2, 500, 5, 40, 15], # opel insignia
    ['Pizza Van', 2000, 40, 2, 1500, 5.5, 40, 15], #sprinter kurz
    ['Runner Van', 2500, 30, 1.5, 2500, 7, 40, 15], #sprinter lang
    ['Monocycle', 150, 60, 5,  100, 1., 30, 10],
    ['Enclosed Monocycle', 400, 50, 4,  200, 2, 40, 15],
    ['Speedbike', 200, 85, 6, 120, 2, 30, 10], # ducati 1199
    ['Chopper', 350, 50, 4,  200, 2.5, 40, 15], # harley davidson breakout
...
Agents = [
    ["name", "rating", "skills"],
    ['Commercial Driver Class I', 15, {'Pilot': 20}],
    ['Commercial Driver Class II', 20, {'Pilot': 30}],
    ['Commercial Driver Class III', 25, {'Pilot': 40}],
    ['Security Driver Class I', 20, {'Pilot': 30, 'Electronic Warfare': 30, 'Ranged Combat': 20}],
    ['Security Driver Class II', 25, {'Pilot': 40, 'Electronic Warfare': 40, 'Ranged Combat': 30}],
    ['Military Driver Class I', 25, {'Pilot': 40, 'Electronic Warfare': 40, 'Ranged Combat': 30, 'Cracking': 20}],
    ['Commercial Drone Pilot Class I', 15, {'Pilot': 20, "Perception": 15}],
    ['Commercial Drone Pilot Class II', 20, {'Pilot': 30, "Perception": 25}],
    ['Commercial Drone Pilot Class III', 25, {'Pilot': 40, "Perception": 30}],
    ['Security Drone Pilot Class I', 20, {'Pilot': 30, 'Perception': 25, 'Electronic Warfare': 30, 'Ranged Combat': 20, 'Dodge': 20, 'Stealth': 15}],
    ['Security Drone Pilot Class II', 25, {'Pilot': 40, 'Perception': 30, 'Electronic Warfare': 40, 'Ranged Combat': 30, 'Dodge': 30, 'Stealth': 35}],
    ['Military Drone Pilot Class I', 25, {'Pilot': 40, 'Perception': 30, 'Electronic Warfare': 40, 'Ranged Combat': 30, 'Dodge': 30, 'Stealth': 25, 'Cracking': 20}],
    ]
